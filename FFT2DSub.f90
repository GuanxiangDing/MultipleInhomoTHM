!******************************************************
! NEWVER: 20190306PL
! BASED ON THE OLD VER 20120515 & ADD CORRELATION PART
! GENERIC FFT SUBROUTINES FOR: CONVOLUTION SUMMATION
! COMPUTE 2D CONVOLUTION USING FFT
! A(I,J)= C(I-L,J-M) * B(L, M)
! TO IMPROVE THE EFFICIENCY, WE INPUT BFFT 
!******************************************************
